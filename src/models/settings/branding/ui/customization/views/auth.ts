...
export const brandingAuthViewsSchema = new Schema(
  {
    ...
    recovery_method_select: { type: String },
    recovery_security_questions: { type: String },
    recovery_sms: { type: String },
    recovery_codes_display: { type: String },
    setup_webauthn: { type: String },
