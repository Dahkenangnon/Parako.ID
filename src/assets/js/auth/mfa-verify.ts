/**
 * MFAVerifyManager - Handles MFA verification form interactions and OTP input management
 *
 * Features:
 ...
 *
 * Translation Support:
 * The MFAVerifyManager supports full internationalization through the `t()` function in Nunjucks templates.
