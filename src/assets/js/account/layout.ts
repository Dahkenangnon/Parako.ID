...
export interface AccountLayoutConfig {
  csrfToken: string;
  userTheme: string;
  routes: {
  ...
  translations?: Partial<AccountLayoutTranslations>;
}

export interface AccountLayoutTranslations {
  switchAccount: string;
...
export type AccountLayoutDialog = Pick<
  typeof dialogService,
  'showAlert' | 'showConfirm'
>;

export class AccountLayoutManager {
  ...
  constructor(
    config: AccountLayoutConfig,
    private readonly dialog: AccountLayoutDialog = dialogService
  ) {
    this.config = config;
  ...
  private cacheElements(): void {
    ...
    this.sidebarUserDropdown = document.getElementById('sidebar-user-dropdown');
    this.accountsLoadingSidebar = document.getElementById(
      'accounts-loading-sidebar'
    );
    this.accountsListSidebar = document.getElementById('accounts-list-sidebar');
    ...
    this.accountsErrorMobile = document.getElementById('accounts-error-mobile');
    this.accountsRetryMobile = document.getElementById('accounts-retry-mobile');
...
export function initializeAccountLayout(): void {
...
if (typeof document !== 'undefined') {
  document.addEventListener('DOMContentLoaded', initializeAccountLayout);
}
