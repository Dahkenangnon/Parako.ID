 ...
 */
// eslint-disable-next-line @typescript-eslint/no-empty-object-type -- a distinct nominal interface per provider lets the DI container bind Facebook-specific implementations separately, even though the contract is identical to the base.
